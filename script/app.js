...
class UI {
        ...
        <div class="product__footer">
          ...
          <div class="bottom">
            <div class="btn__group">
              ...
              <button class="btn btn-buy view">Buy Now</button>
            </div> <br>
  ...
  getButtons() {
    ...
    buttons.forEach(button => {
      ...
      if (inCart) {
        ...
        button.innerHTML = `<i class="fas fa-check"></i> On Cart`
        // button.style.color = '#fff'
        // button.style.backgroundColor = '#ff7417'
        button.style.color = '#ff7417'
        button.style.borderColor = '#ff7417'
  ...
  setItemValues(cart) {
    ...
    itemTotals.style.backgroundColor = ''
    itemTotals.style.color = 'white'
  }
...
class Products {
  async getProducts() {
    try {
      const result = await fetch("script/products.json")
